...
Если информация о вашей компании живёт на сайте, её можно не переносить в файлы вручную: в панели «📄 Документы» есть кнопка **«🌐 Индексировать сайт»** — укажите адрес, и система обойдёт страницы и соберёт из них один текстовый файл `site_домен.txt`. Обновлять его потом можно кнопкой **⟳ «Обновить с сайта»** прямо в списке документов.
